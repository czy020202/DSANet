...
BASE = '/ChestCT2025/' # make sure you have the ending '/'
data_config = {
...
train_config = {
    ...
    'val_set_list': BASE + 'test.txt',
    'test_set_name': BASE + 'test.txt',
    'train_anno': BASE + 'train_anno.csv',
    'test_anno': BASE + 'test_anno.csv',
